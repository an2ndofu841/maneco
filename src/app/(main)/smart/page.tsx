        ...
        <div className="mb-8">
          ...
          <div className="flex bg-slate-100 p-1 rounded-2xl max-w-md mb-6">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all active:scale-[0.97] ${
                activeTab === 'coupon'
            ...
            >
              ...
              <span className="truncate">クーポン</span>
            </button>
            <button
            ...
            >
              ...
              <span className="truncate">旅行プランナー</span>
            </button>
          </div>
        </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              {USAGE_TYPES.map((usage) => (
                <button
                  ...
                  className={`relative overflow-hidden rounded-2xl p-3 sm:p-4 h-24 sm:h-28 flex flex-col items-center justify-center gap-1.5 sm:gap-2 transition-all active:scale-95 ${
                ...
                >
                  ...
                  <span className="font-bold text-slate-900 text-xs sm:text-sm">{usage.label}</span>
                  {selectedUsage === usage.id && (
                        ...
                        <div className="flex-1 p-4 flex flex-col justify-between">
                          ...
                          <div className="flex items-end justify-between mt-3">
                            ...
                            {usedCouponIds.has(coupon.id) ? (
                              <span className="flex items-center gap-1 text-xs font-bold text-slate-400 bg-slate-100 px-3.5 py-2 rounded-lg">
                                <CheckCircle className="w-3.5 h-3.5" /> 使用済み
                              </span>
                            ) : (
                              <button
                                onClick={() => handleUseCoupon(coupon)}
                                className="flex items-center gap-1 text-xs font-bold text-white bg-slate-900 px-3.5 py-2 rounded-lg hover:bg-slate-800 active:scale-95 transition-all shadow-sm min-h-[2.5rem]"
                              >
                                使う <ExternalLink className="w-3.5 h-3.5" />
                              </button>
                            )}
                          </div>
                        </div>
